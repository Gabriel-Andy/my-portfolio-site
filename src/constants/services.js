...
export default [
  {
    ...
    text: `I am very proficient with REACT.JS and GATSBY.JS and able to create beautiful sites`,
  },
  {
    id: 2,
    icon: <FaHtml5 className="service-icon" />,
    title: "html email",
    text: `I able to create html email quickly and effective`,
  },
  {
    id: 3,
    icon: <FaMobileAlt className="service-icon" />,
    title: "responsive design",
    text: `I am able to create responsive sites at the professional level`,
  },
  {
    id: 4,
